...
export function Tasks() {
  ...
  return (
    ...
    >
      ...
      <div className="space-y-3">
        {activeTasks.length === 0 ? (
          ...
          activeTasks.map((task) => (
            ...
            >
              {/* กดตรงนี้เพื่อดูรายละเอียด */}
              <button onClick={() => setSelectedTask(task)} className="w-full text-left mb-2">
      ...
      {/* Task Detail Modal — แยกออกมาเป็น component ที่ src/components/TaskDetailModal.tsx */}
